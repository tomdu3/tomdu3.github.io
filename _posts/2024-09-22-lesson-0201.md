...
## 2.3. Functions
[Functions in Python Documentation](https://docs.python.org/3/tutorial/controlflow.html#defining-functions)
...
**Why didn't anything happen when we ran the previous code cell?**
We only *defined* the function (wrote down the recipe). To see the result, we must *call* it (follow the recipe).
